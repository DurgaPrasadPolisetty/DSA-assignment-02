...
int main(){
    ...
    while (1)
    {
        ...
        printf("4. Display the student list\n");
        ...
        case 2:
            ...
            printf("Enter the students's name to insert: ");
            scanf("%s", name);
            int position;
        ...
        case 3:
            ...
            if(deleteMethod == 'n'){
                ...
                printf("Enter the students name to delete");
                scanf("%s", deleteName);
                for(int i = 0; i < size; i++){
        ...
        case 5:
            ...
            printf("Enter the students name to search: ");
            scanf("%s", searchName);
